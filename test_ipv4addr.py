...
class TestIPv4Address(unittest.TestCase):
    ...
    A1234 = bytearray([1, 2, 3, 4])
    A1235 = bytearray([1, 2, 3, 5])
    ...
    def testV4AddrWithPort(self):
        ...
        self.assertEqual(97, v4addr.getPort())
    ...
    def test_private_ips(self):
        ...
        self.assertEqual(80, v4addr.getPort())
        ...
        self.assertTrue(IPv4Address.is_private(addr))
        self.assertEqual(8080, v4addr.getPort())

        addr = IPv4Address("127.255.0.4:8080").get_ip_address()
        self.assertFalse(IPv4Address.is_private(addr))
        addr = IPv4Address("128.1.0.4:8080").get_ip_address()
        self.assertFalse(IPv4Address.is_private(addr))

        # Web server running in 172.16/12
        v4addr = IPv4Address("172.30.0.1:443")
        addr = v4addr.get_ip_address()
        self.assertEqual(-84, addr[0])
        self.assertEqual(30, addr[1])
        self.assertEqual(0, addr[2])
        self.assertEqual(1, addr[3])
        self.assertTrue(IPv4Address.is_private(addr))
        self.assertEqual(443, v4addr.getPort())

        addr = IPv4Address("172.15.0.1:443").get_ip_address()
        self.assertFalse(IPv4Address.is_private(addr))
        addr = IPv4Address("172.32.0.1:443").get_ip_address()
        self.assertFalse(IPv4Address.is_private(addr))
    ...
    def test_rfc3330(self):
        ...
        self.assertTrue(IPv4Address.is_rfc3330not_private(test))
        # 14/8
        test[0] = 14
        self.assertTrue(IPv4Address.is_rfc3330(test))
        # 24/8
        ...
        test = IPv4Address("169.254.0.1:443").get_ip_address()
        self.assertEqual(-87, test[0])
        self.assertEqual(-2, test[1])
        self.assertTrue(IPv4Address.is_rfc3330(test))
        self.assertFalse(IPv4Address.is_private(test))

        # 192.0.2.0/24, test net
        test = IPv4Address("192.0.2.14:443").get_ip_address()
        self.assertEqual(-64, test[0])
        self.assertTrue(IPv4Address.is_rfc3330(test))
        self.assertFalse(IPv4Address.is_private(test))

        # 192.88.99.0/24, 6to4 relay anycast
        test = IPv4Address("192.88.99.14:443").get_ip_address()
        self.assertEqual(-64, test[0])
        self.assertTrue(IPv4Address.is_rfc3330(test))

        # 198.18/15, benchmark testing
        test = IPv4Address("198.18.99.14:443").get_ip_address()
        self.assertEqual(-58, test[0])
        self.assertTrue(IPv4Address.is_rfc3330(test))
        test = IPv4Address("198.19.99.14:443").get_ip_address()
        self.assertTrue(IPv4Address.is_rfc3330(test))

        # 224/4, multicast
        test = IPv4Address("224.18.99.14:443").get_ip_address()
        self.assertEqual(-32, test[0])
        self.assertTrue(IPv4Address.is_rfc3330(test))

        # 240/4, reserved
        v4addr = IPv4Address("240.18.99.14:443")
        test = v4addr.get_ip_address()
        self.assertEqual(-16, test[0])
        self.assertTrue(IPv4Address.is_rfc3330(test))
